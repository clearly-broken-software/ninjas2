...
StateSwitch::StateSwitch(Window &parent, Size<uint> size) noexcept : NanoSwitch(parent, size),
...
StateSwitch::StateSwitch(NanoWidget *widget, Size<uint> size) noexcept : NanoSwitch(widget, size),
